...
module.exports = {
    ...
    executar: async (sock, msg, args) => {
        ...
        if (!args[0]) {
            return sock.sendMessage(from, { text: "❌ Digite o número para desbloquear." });
        }
        ...
        try {
            ...
            await sock.sendMessage(from, { text: `✅ Número ${args[0]} desbloqueado com sucesso.` });
        } catch (error) {
            await sock.sendMessage(from, { text: "❌ Erro ao desbloquear número." });
        }
    }
};
