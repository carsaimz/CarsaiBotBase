...
module.exports = {
    ...
    executar: async (sock, msg, commandArgs) => {
        ...
        if (!commandArgs[0]) {
            return sock.sendMessage(fromJid, { text: "❌ Digite uma cidade.\nExemplo: !clima Maputo" });
        }
        
        const cidade = commandArgs.join(' ');
        ...
        try {
            ...
            await sock.sendMessage(fromJid, { text: climaTexto }, { quoted: msg });
        } catch (error) {
            await sock.sendMessage(fromJid, { text: "❌ Cidade não encontrada ou error na consulta." });
        }
    }
};
